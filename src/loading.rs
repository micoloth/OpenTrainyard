...
pub struct TileAssets {
    ...
    #[asset(path = "samples/scissor_u_inner.png")] pub scissor_u_inner: Handle<Image>,
    ...
    #[asset(path = "samples/e_base_inner.png")] pub e_base_inner: Handle<Image>,
...
pub fn get_asset(name: String, asset_server: &TileAssets)-> Handle<Image> {
    ...
    match &name[..] {
       "s_elem_1_blue.png" => {asset_server.s_elem_1_blue.clone()},
        ...
        "scissor_u_inner.png" => {asset_server.scissor_u_inner.clone()},
        ...
        "e_base_inner.png" => {asset_server.e_base_inner.clone()},
